<x-landing-page>
    <div class="w-full min-h-screen flex flex-col gap-2">
        ...
        <div class="w-full h-screen" id="home">
        ...
        <section class="text-gray-600 body-font">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                ...
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6" data-aos="fade-left" data-aos-delay="600">
        ...
        <section class="text-gray-600 body-font" id="room">
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-col text-center w-full mb-20">
                    <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">ROOF PARTY POLAROID
                    </h2>
                    <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900">Rooms
                    </h1>
                </div>
                            ...
                            <div class="flex rounded-lg h-full bg-white p-8 flex-col">
                                <div class="flex items-center mb-3">
                                    <div
                                        ...
                                        <img src="{{asset('images/icons/available.png')}}" alt="" srcset="" class="object object-center h-full w-full">
                                    ...
                                    <h2 class="text-gray-900 text-lg title-font font-medium">Room #: {{$room->room_number}}</h2>
                                </div>
                                {{-- <div class="flex-grow">
        ...
        <section class="text-gray-600 body-font" data-aos="fade-up" data-aos-dalay="600" id="about">
            <div class="container px-5 py-24 mx-auto">
                <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                    ...
                    <p class="leading-relaxed text-lg text-justify">Edison bulb retro cloud bread echo park, helvetica
                        stumptown
                    ...
                    <h2 class="text-gray-900 font-bold title-font tracking-wider text-lg">About Us</h2>
                    <p class="text-gray-500">Golden Annex Apartment</p>
                </div>
            </div>
        </section>
        ...
        <section class="text-gray-600 body-font relative" id="contact">
            <div class="absolute inset-0 bg-gray-300">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15454.854614499569!2d120.98174890127717!3d14.443658705988032!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d1e416255bdd%3A0x13912a588cd2dc28!2sTalon%20Village%20National%20High%20School!5e0!3m2!1sen!2sph!4v1700545868635!5m2!1sen!2sph"
                    width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"
                    referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <form method="POST" action="{{ route('send.request') }}" class="container px-5 py-24 mx-auto flex">
            ...
            <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                  ...
                  <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
                    ...
                    <span class="ml-3 text-xl"><span class="text-blue-400 font-bold">Golden Annex</span> <span
                            class="text-gray-600">Apartment</span></span>
                </a>
                <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
                    ©
                    2023 GoldenAnnexAparment —
                    <a href="https://twitter.com/knyttneve" class="text-gray-600 ml-1" rel="noopener noreferrer"
                        target="_blank">@groupAmiraSakalam</a>
                </p>
